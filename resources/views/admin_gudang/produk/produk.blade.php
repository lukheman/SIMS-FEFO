                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="form-group">
                                            <label for="tingkat_konversi">Jumlah <span class="unit-kecil"></span>/<span
                                                    class="unit-besar"></span> </label>
                                            <input type="number" class="form-control" name="tingkat_konversi"
                                                id="tingkat_konversi" min="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <div class="form-group">
                                            <label for="harga-beli">Harga Beli/<span class="unit-besar"></span>
                                                (Rp.)</label>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="form-group">
                                            <label for="harga-jual">Harga Jual/<span class="unit-besar"></span>
                                                (Rp.)</label>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="form-group">
                                            <label for="harga_jual_unit_kecil">Harga Jual/<span
                                                    class="unit-kecil"></span> (Rp.)</label>
                                            <input type="number" class="form-control" name="harga_jual_unit_kecil"
                                                id="harga_jual_unit_kecil" min="0">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row d-none input-produk-biaya">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="biaya_pemesanan"
                                        id="biaya-pemesanan" placeholder="Biaya Pemesanan" min="0">
                                </div>
                            </div>
